...
import com.projectlab.travelin_android.flight.components.moleculas.flightqueryscreen.FlightQueryBottomBar
import com.projectlab.travelin_android.flight.components.moleculas.flightqueryscreen.FlightQueryForm
...
fun FlightQueryScreen(
    ...
    Scaffold(
        ...
        bottomBar = {
            Surface(
                // sombra alrededor; tonalElevation para Material3
                shadowElevation = 30.dp,
                // para que la sombra no recorte los bordes, si quieres curvas:
