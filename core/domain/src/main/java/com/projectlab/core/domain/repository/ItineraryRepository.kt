...
interface ItineraryRepository {
    ...
    suspend fun getItineraryById(userId: String, itineraryId: String): Flow<ItineraryEntity?>
    suspend fun getAllItineraries(userId: String): Flow<List<ItineraryEntity>>
